...
import com.crayon.fieldapp.databinding.FragmentListReportSalesAtStoreBinding
...
import com.crayon.fieldapp.ui.screen.monitor.reportSales.listTask.adapter.ManageReportSalesRVAdapter
...
class ListReportSalesAtStoreFragment() :
    BaseFragment<FragmentListReportSalesAtStoreBinding, ListReportSalesAtStoreViewModel>() {

    override val layoutId: Int
        get() = R.layout.fragment_list_report_sales_at_store
    ...
    private var mAdapter: ManageReportSalesRVAdapter? = null
    ...
    override val viewModel: ListReportSalesAtStoreViewModel by viewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.icSelectDate.setSingleClick {
            val datepicker = SelectDatePickerDialog(
                agencyId = agencyId.toString(),
                projectId = projectId.toString(),
                taskType = TaskType.REPORT_SALES.value, itemClickListener = {
                    calendar = it
                    formatTime()
                }
            )
    ...
    private fun toTaskDetail(task: String) {
        ...
        findNavController().navigate(R.id.action_list_reportSales_to_detail_reportSales, bundel)
    }
