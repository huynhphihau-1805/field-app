...
class ExportGiftFragment : BaseFragment<FragmentExportGiftBinding, ExportGiftViewModel>() {

    override val layoutId: Int = R.layout.fragment_export_gift
    override val viewModel: ExportGiftViewModel by viewModel()
    private lateinit var mGiftAdapter: ExportGiftAdapter
