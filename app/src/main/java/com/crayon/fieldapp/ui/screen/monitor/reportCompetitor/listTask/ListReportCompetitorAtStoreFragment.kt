...
class ListReportCompetitorAtStoreFragment() :
    BaseFragment<FragmentListReportCompetitorAtStoreBinding, ListReportCompetitorAtStoreViewModel>() {

    override val layoutId: Int
        get() = R.layout.fragment_list_report_competitor_at_store
    ...
    override val viewModel: ListReportCompetitorAtStoreViewModel by viewModel()
    ...
    private fun toTaskDetail(task: String) {
        ...
        findNavController().navigate(
            R.id.action_list_reportCompetitor_to_detail_reportCompetitor,
            bundel
        )
    }
