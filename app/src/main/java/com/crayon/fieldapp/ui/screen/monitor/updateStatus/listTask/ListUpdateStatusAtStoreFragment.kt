...
import com.crayon.fieldapp.databinding.FragmentListUpdateStatusAtStoreBinding
...
class ListUpdateStatusAtStoreFragment() :
    BaseFragment<FragmentListUpdateStatusAtStoreBinding, ListUpdateStatusAtStoreViewModel>() {

    override val layoutId: Int
        get() = R.layout.fragment_list_update_status_at_store
    ...
    override val viewModel: ListUpdateStatusAtStoreViewModel by viewModel()
    ...
    private fun toTaskDetail(task: String) {
        ...
        findNavController().navigate(R.id.action_list_updateStatus_to_detail_updateStatus, bundel)
    }
